...
const int IN1_PIN = 8;   // L298N pin IN1
const int IN2_PIN = 9;   // L298N pin IN2
const int IN3_PIN = 10;  // L298N pin IN3
const int IN4_PIN = 11;  // L298N pin IN4
